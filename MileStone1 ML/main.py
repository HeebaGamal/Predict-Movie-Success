...
print('Mean Square Error train Linear ', metrics.mean_squared_error(np.asarray(Y_train), prediction))
print('R2 Score train Linear ', metrics.r2_score(np.asarray(Y_train), prediction))

prediction = cls.predict(X_test)
print('Mean Square Error test Linear ', metrics.mean_squared_error(np.asarray(Y_test), prediction))
print('R2 Score test Linear ', metrics.r2_score(np.asarray(Y_test), prediction))
print()
#endregion
...
prediction = Polynomial_Model.predict(X_train)
print('Mean Square Error train Polynomial ', metrics.mean_squared_error(np.asarray(Y_train), prediction))
print('R2 Score train Polynomial ', metrics.r2_score(np.asarray(Y_train), prediction))

prediction = Polynomial_Model.predict(X_test)
print('Mean Square Error test Polynomial ', metrics.mean_squared_error(np.asarray(Y_test), prediction))
print('R2 Score test Polynomial ', metrics.r2_score(np.asarray(Y_test), prediction))
#endregion
